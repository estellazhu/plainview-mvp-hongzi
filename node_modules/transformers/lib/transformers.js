...
exports.hbs = new Transformer({
  name: 'hbs',
  engines: ['hbs', 'then-hbs'],
  outputFormat: 'xml',
  sudoSync: 'The hbs file FILENAME could not be rendered syncronously.  N.B. then-hbs does not support syncronous rendering.',
  async: function (str, options, cb) {
    this.cache(options, true);//hbs handles this.cache internally
...
exports['html2hbs'] = new Transformer({
  name: 'html2hbs',
  engines: ['html2hbs'],
  outputFormat: 'hbs',
  async: function (str, options, cb) {
